...
export const profile = {
  ...
  education: [
    ...
    {
      school: 'Shri Vaishnav Vidyapeeth Vishwavidyalaya, Indore, MP',
      degree: 'Senior Secondary (XII) — PCM with Computer Science',
      dates: '2022 – 2023',
      gpa: '82%',
      type: 'school',
    },
    {
      school: 'New Digamber Public School, Indore, MP',
      degree: 'Secondary (X)',
      dates: '2020 – 2021',
      gpa: '85%',
      type: 'school',
